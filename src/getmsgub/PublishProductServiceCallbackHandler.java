...
public abstract class PublishProductServiceCallbackHandler {
    ...
    public void receiveResultgetAllProducts(
        getmsgub.PublishProductServiceStub.GetAllProductsResponse result) {
    }
    ...
    public void receiveResultgetListOfProducts(
        getmsgub.PublishProductServiceStub.GetListOfProductsResponse result) {
    }
    ...
    public void receiveResultgetPublishString(
        getmsgub.PublishProductServiceStub.GetPublishStringResponse result) {
    }
    ...
    public void receiveResultgetPublishModel(
        getmsgub.PublishProductServiceStub.GetPublishModelResponse result) {
    }
